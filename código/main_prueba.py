...
async def buzon(request: Request, mensaje: Mensaje):
    ...
    r = requests.post(
        OLLAMA_URL,
        json={
            #"messages":[{'role': 'Eres un jugador de Catan que tieen que negociar con otro y ver si los recursos que te piden los tienes tu', 'content': mensaje.msg}],
            "role": 'Eres un jugador de Catan que tieen que negociar con otro y ver si los recursos que te piden los tienes tu', 
            "model": DEFAULT_MODEL,
            "prompt": mensaje.msg,
